...
% c1_test = (1 - lambda*C.L*K11*besseli(0,lambda*sol.x(1:11)));
% c2_test = lambda*C.L*I11*besselk(0,lambda*sol.x(12:38));
% c_test = [c1_test c2_test];
% res = (c_test - sol.y(1,1:38)/A)./(sol.y(1,38)/A);
% sig_res = sum(abs(res))/length(res);
% figure;plot(sol.x(1:38),sol.y(1,1:38)/A)
% xlim([0,5])
% hold on
% plot(sol.x(1:38), c_test)
...
f = gcf;
exportgraphics(f,'fig2b.jpg','Resolution',300)
