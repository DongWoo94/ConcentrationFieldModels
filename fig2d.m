...
% analytic solution
c1 = (1 - exp(-lambda*C.L)*cosh(lambda*xl));
c2 = sinh(lambda*C.L)*exp(-lambda*xu);
c = [c1 c2];

% num1 = plot(sol.x,sol.y(1,:)/A,'o');
ana1 = plot(xmesh,c,'-','LineWidth',1);
...
legend([ana1 ana2 ana3],{"R' = 0.3","R' = 1","R' = 3"}, 'Location','southwest') 

exportgraphics(fig,'fig2d.jpg','Resolution',300)
